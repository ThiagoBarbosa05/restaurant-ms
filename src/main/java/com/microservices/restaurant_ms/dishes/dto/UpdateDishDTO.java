...
public record UpdateDishDTO(
  ...
  @NotNull(message = "É preciso informar o id da categoria do prato") UUID category_id,

  @NotNull(message = "É preciso informar o id da imagem do prato")
  UUID attachment_id,

  @NotEmpty(message = "Insira ao menos um ingrediente do prato") List<String> ingredients
) {
